...
export const cityGuess = () => fetch('http://cangdu.org:8001/v1/cities', {
	type: 'guess'
});
...
export const hotcity = () => fetch('http://cangdu.org:8001/v1/cities', {
	type: 'hot'
});
...
export const groupcity = () => fetch('http://cangdu.org:8001/v1/cities', {
	type: 'group'
});
...
export const currentcity = number => fetch('http://cangdu.org:8001/v1/cities/' + number);
...
export const msiteFoodTypes = geohash => fetch('/static/index-0.json', {
	geohash,
	group_type: '1',
	'flags[]': 'F'
});
...
export const shopList = (latitude, longitude, offset, restaurant_category_id = '', restaurant_category_ids = '', order_by = '', delivery_mode = '', support_ids = []) => {
	...
	return fetch('/static/index-1.json', data);
};
