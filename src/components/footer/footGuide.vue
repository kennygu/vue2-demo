<template>
  <section id='foot_guide'>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position:absolute;width:0;height:0">
      <defs>
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink"  viewBox="5 5 38 36" id="msite">
          <g fill="none" fill-rule="evenodd" stroke="#666" stroke-width="2">
            <path d="M20 40V28h8v12h10V24h6L24 6 4 24h6v16z"></path>
          </g>
        </symbol>

        <symbol viewBox="5 5 38 36" id="msiteActive">
          <defs>
            ...
            <path id="index.18edf5a_b" d="M20 40V28h8v12h10V24h6L24 6 4 24h6v16z"></path>
          ...
          <g fill="none" fill-rule="evenodd">
            <g transform="translate(1 1)">
              ...
              <use stroke="url(#index.18edf5a_c)" stroke-width="1.6" mask="url(#index.18edf5a_f)" xlink:href="#index.18edf5a_b"></use>
            </g>
          </g></symbol>
